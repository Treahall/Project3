...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    public override fun onStart() {
        super.onStart()
        //Check if the User is signed in (not-null) and update
    ...
    public fun updateUI(currentUser: FirebaseUser?) {
        ...
        if(currentUser != null) {
            ...
            // http://www.appsdeveloperblog.com/firebase-social-authentication-example-login/
    ...
    fun doLoginStuff(){
        ...
        //Create and launch sigh in intent
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == RC_SIGN_IN) {
            ...
            if(resultCode == Activity.RESULT_OK){
                ...
                //Sigh in failed, check response for error code
                // ...
                this.updateUI(null)
            }
        }
